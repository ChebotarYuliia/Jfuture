                        ...
                        <div class="contact-form__container">
                            ...
                            <form action="" class="contact-form pbz_form clear-styles">
                                <div class="contact-form__row">
                                    ...
                                    <input type="tel" name="phone" data-title="Телефон" data-validate-required="<?php echo __('[:en]Required field[:ru]Обязательное поле[:]'); ?>" data-validate-uaphone="<?php echo __('[:en]Wrong phone number[:ru]Неправильный номер[:]'); ?>" placeholder="+38 (0__) __ __ ___" class="custom-intup">
                                </div>
                                <div class="contact-form__row">
                                    <input  type="email" name="email" placeholder="Email" data-title="Email" data-validate-required="<?php echo __('[:en]Required field[:ru]Обязательное поле[:]'); ?>" data-validate-email="<?php echo __('[:en]Wrong email[:ru]Неправильный email[:]'); ?>" class="custom-intup">
                                    <input type="text" name="country" data-title="Страна" data-validate-required="<?php echo __('[:en]Required field[:ru]Обязательное поле[:]'); ?>" placeholder="<?php echo __('[:en]Country[:ru]Страна[:]'); ?>" class="custom-intup">
                                </div>
                                <div class="contact-form__row">
                                    <input type="text" name="city" data-title="Город" data-validate-required="<?php echo __('[:en]Required field[:ru]Обязательное поле[:]'); ?>" placeholder="<?php echo __('[:en]City[:ru]Город[:]'); ?>" class="custom-intup">
                                </div>
                                <label for="teaxtarea" class="custom-label"><?php echo __('[:en]Yout question?[:ru]Ваш Вопрос?[:]'); ?> </label>
                                <textarea class="custom-textarea" id="teaxtarea" cols="20" rows="7" name="question" data-title="Вопрос"></textarea>
                        ...
                        <div class="contact-form__container">
                            ...
                            <form action="" class="contact-form pbz_form clear-styles">
                                <div class="contact-form__row">
                                    ...
                                    <input type="text"  name="ch_name" placeholder="<?php echo __('[:en]Child name[:ru]Имя Ребенка[:]'); ?>" data-title="Имя" class="custom-intup">
                                </div>
                                <div class="contact-form__row">
                                    <input  type="email" name="email" placeholder="Email" data-title="Email" data-validate-required="<?php echo __('[:en]Required field[:ru]Обязательное поле[:]'); ?>" data-validate-email="<?php echo __('[:en]Wrong email[:ru]Неправильный email[:]'); ?>" class="custom-intup">
                                    <input type="tel" name="phone" data-title="Телефон" data-validate-required="<?php echo __('[:en]Required field[:ru]Обязательное поле[:]'); ?>" data-validate-uaphone="<?php echo __('[:en]Wrong phone number[:ru]Неправильный номер[:]'); ?>" placeholder="+38 (0__) __ __ ___" class="custom-intup">
